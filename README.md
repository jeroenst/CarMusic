...
- Shows Title, artist, album, folder, bitrate and codec type
  ...
  - Responds to media buttons like steering wheel control
...
Any help to develop this app is welcome, the app license allows you to do anything you want with it.
